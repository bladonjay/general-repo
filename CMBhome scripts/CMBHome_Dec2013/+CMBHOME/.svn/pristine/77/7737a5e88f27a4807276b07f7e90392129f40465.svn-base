function x = RemoveJumpsAndSmooth(x, max_allowed_flips, jitter_threshold, smooth_std)
...
% andrew june 15 2011
    ...
    if smooth_std>0
        x = ndnanfilter(x, normpdf(-6:6, 0, smooth_std)', [], 1, {}, {}, 1); % convolve with gaussian and ignore NaNs
    end
